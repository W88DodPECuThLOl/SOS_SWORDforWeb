...
clang "-Wl,--no-entry" "-Wl,--export-all" "-Wl,--import-memory" -fno-builtin -nostdlib --target=wasm32 -o sos.wasm sos.o catLowMemory.o clang.o platform.o catPlatformFactory.o catCtc.o catCRTC.o catPCG.o catPlatformX1.o catPlatformMZ700.o cat8253.o
